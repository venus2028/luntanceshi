...
FCKConfig.Plugins.Add( 'Media', 'en,zh,zh-cn' ) ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Smiley','SpecialChar','Media'], // 加入Media按钮
...
FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','TextColor','BGColor','-','OrderedList','UnorderedList','-','Link','Unlink','Image','Flash','Media','-','About']
];
*/
FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','TextColor','BGColor','-','OrderedList','UnorderedList','-','Link','Unlink','Image','Flash','-','About']
];
...
FCKConfig.FontNames		= '宋体;黑体;幼圆;隶书;楷体_GB2312;仿宋_GB2312;Arial;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
