...
<frameset rows="*" cols="180,*" framespacing="0" border="0">
  <frame src="../../../../cms/img_left.jsp?action=<%=action%>&dir=<%=StrUtil.UrlEncode(dir)%>" name="leftFileFrame" >
  <frame src="../../../../cms/img_list.jsp?action=<%=action%>&dir=<%=StrUtil.UrlEncode(dir)%>" name="mainFileFrame">
</frameset>
<noframes><body>
</body></noframes>
</html>
