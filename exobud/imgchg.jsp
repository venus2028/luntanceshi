...
<%
String imgchgRootPath = request.getContextPath() + "/exobud";
String style = cn.js.fan.util.ParamUtil.get(request, "style");
if (!style.equals(""))
	imgchgRootPath += "/" + style;
%>
<!--
//
// ■ 进行动态按钮图档的切换动作
...
if(document.images){
 ...
 img.vmute_off.src = "<%=imgchgRootPath%>/img/btn_mute_off.gif";
 img.vmute_on = new Image();
 img.vmute_on.src = "<%=imgchgRootPath%>/img/btn_mute_on.gif";
 
 // “播放顺序模式”按钮的图档 (循序／随机)
 img.pmode_off = new Image();
 img.pmode_off.src = "<%=imgchgRootPath%>/img/btn_rndmode_off.gif";
 img.pmode_on = new Image();
 img.pmode_on.src = "<%=imgchgRootPath%>/img/btn_rndmode_on.gif";

 // “是否重复播放”按钮的图档 (不重复／重复)
 img.rept_off = new Image();
 img.rept_off.src = "<%=imgchgRootPath%>/img/btn_rept_off.gif";
 img.rept_on = new Image();
 img.rept_on.src = "<%=imgchgRootPath%>/img/btn_rept_on.gif";

 // “播放”按钮的图档 (非播放中／播放中／滑鼠移至时)
 img.playt_off = new Image();
 img.playt_off.src = "<%=imgchgRootPath%>/img/btn_play.gif";
 img.playt_on = new Image();
 img.playt_on.src = "<%=imgchgRootPath%>/img/btn_play_on.gif";
 img.playt_ovr = new Image();
 img.playt_ovr.src = "<%=imgchgRootPath%>/img/btn_play_ovr.gif";

 // “暂停”按钮的图档 (非暂停中／暂停中／滑鼠移至时)
 img.pauzt_off = new Image();
 img.pauzt_off.src = "<%=imgchgRootPath%>/img/btn_pauz_off.gif";
 img.pauzt_on = new Image();
 img.pauzt_on.src = "<%=imgchgRootPath%>/img/btn_pauz_on.gif";
 img.pauzt_ovr = new Image();
 img.pauzt_ovr.src = "<%=imgchgRootPath%>/img/btn_pauz_ovr.gif";

 // “停止”按钮的图档 (未被停止／已停止／滑鼠移至时)
 img.stopt_off = new Image();
 img.stopt_off.src = "<%=imgchgRootPath%>/img/btn_stop.gif";
 img.stopt_on = new Image();
 img.stopt_on.src = "<%=imgchgRootPath%>/img/btn_stop_on.gif";
 img.stopt_ovr = new Image();
 img.stopt_ovr.src = "<%=imgchgRootPath%>/img/btn_stop_ovr.gif";

 // “上一首曲目”按钮的图档 (一般显示／滑鼠移至时)
 img.prevt_out = new Image();
 img.prevt_out.src = "<%=imgchgRootPath%>/img/btn_prev.gif";
 img.prevt_ovr = new Image();
 img.prevt_ovr.src = "<%=imgchgRootPath%>/img/btn_prev_ovr.gif";

 // “下一首曲目”按钮的图档 (一般显示／滑鼠移至时)
 img.nextt_out = new Image();
 img.nextt_out.src = "<%=imgchgRootPath%>/img/btn_next.gif";
 img.nextt_ovr = new Image();
 img.nextt_ovr.src = "<%=imgchgRootPath%>/img/btn_next_ovr.gif";

 // “增加音量”按钮的图档 (一般显示／滑鼠移至时)
 img.vup_out = new Image();
 img.vup_out.src = "<%=imgchgRootPath%>/img/btn_vup.gif";
 img.vup_ovr = new Image();
 img.vup_ovr.src = "<%=imgchgRootPath%>/img/btn_vup_ovr.gif";

 // “减少音量”按钮的图档 (一般显示／滑鼠移至时)
 img.vdn_out = new Image();
 img.vdn_out.src = "<%=imgchgRootPath%>/img/btn_vdn.gif";
 img.vdn_ovr = new Image();
 img.vdn_ovr.src = "<%=imgchgRootPath%>/img/btn_vdn_ovr.gif";

 // “显示播放清单内容”按钮的图档 (一般显示／滑鼠移至时)
 img.plist_out = new Image();
 img.plist_out.src = "<%=imgchgRootPath%>/img/btn_plist.gif";
 img.plist_ovr = new Image();
 img.plist_ovr.src = "<%=imgchgRootPath%>/img/btn_plist_ovr.gif";

 // 显示播放状态的 Scope 动态图档 (静止／转动)
 img.scope_off = new Image();
 img.scope_off.src = "<%=imgchgRootPath%>/img/scope_off.gif";
 img.scope_on = new Image();
 img.scope_on.src = "<%=imgchgRootPath%>/img/scope_on.gif";
