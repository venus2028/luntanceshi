  ...
  <tr valign="middle">
    <td width=25% align=left class="userInfo">
		  ...
		  <li><%=user.getNick()%></li>
			...
			<li><lt:Label res="res.label.forum.showtopic" key="rank"/></li>
            <li><%=user.getLevelDesc()%></li>
            <%
            ...
            <li><lt:Label res="res.label.forum.showtopic" key="reg_date"/></li>
            <li><%=RegDate%></li>
            <li><lt:Label res="res.label.forum.showtopic" key="online_status"/></li>
            <%
