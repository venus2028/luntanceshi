...
com.redmoon.blog.Config myconfig = com.redmoon.blog.Config.getInstance();
...
if (name!=null && !name.equals("")) {
	...
	myconfig.reload();
	myconfig = com.redmoon.blog.Config.getInstance();	
	return;
}
      ...
      <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
        <FORM METHOD=POST id="form<%=k%>" name="form<%=k%>" ACTION='config_m.jsp'>
          <tr> 
			...
			<%} else if (name.equals("modifyTemplateUserLevel") || name.equals("createBlogUserLevel")) {%>
				<select name="value">
				<%
