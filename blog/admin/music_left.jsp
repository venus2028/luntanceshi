...
%>
<jsp:useBean id="dm" scope="page" class="com.redmoon.blog.music.DirMgr"/>
<%
...
DirDb leaf = dm.getDirDb(root_code);
if (op.equals("repair")) {
	dm.repairTree(leaf);
	leaf = dm.getDirDb(root_code);
}
...
DirView dv = new DirView(leaf);
dv.ListSimple(out, "mainFileFrame", "listmusic.jsp?action=" + action + "&dir_code=", "", "" );
%></TD>
    </TR>
  </TBODY>
</TABLE>
