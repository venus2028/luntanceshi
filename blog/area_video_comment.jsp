...
pd = (VideoDb)pd.getQObjectDb(new Long(videoId));
...
<%} 
if (pd.getInt("is_locked")==0) {
%>
<br />
<a name='form'></a>
<form name="frmAnnounce" action="showvideo.jsp" method=post onsubmit="return formCheck()">
    ...
    <tbody>
      ...
      <tr bgcolor=#ffffff>
		...
		%>
            ...
            <input name="video_id" value="<%=videoId%>" type="hidden" />
...
%>
            ...
            <%}%>
        </div><input tabindex=4 type=submit value="<lt:Label res="res.label.forum.showblog" key="comment"/>" name=submit1></td>
      </tr>
  </tbody>
</table>
</form>
