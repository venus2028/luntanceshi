...
if (op.equals("edit")) {
	...
	out.print(StrUtil.Alert_Redirect("操作成功！", "template_page_edit.jsp?id=" + id));
}
%>
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">编辑模板&nbsp;-&nbsp;<%=td.getString("name")%></td>
  </tr>
</table>
<table width="100%" align="center">
  <form id=formFck name=formFck action="?op=edit" method=post onSubmit="return formFck_onsubmit()">
    <tr>
      <td height="22"><input name="id" type="hidden" value="<%=id%>">
<%
