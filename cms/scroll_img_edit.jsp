...
if (op.equals("edit")) {
	...
	try {
		if (qom.save(request, sfd, "site_scroll_img_save")) {
			out.print(StrUtil.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "scroll_img_edit.jsp?id=" + id + "&siteCode=" + siteCode + "&kind=" + sfd.getString("kind")));
		}
		else {
...
<TABLE cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
  <TR>
    <TD class=head><a href="scroll_img_list.jsp?siteCode=<%=siteCode%>&kind=<%=sfd.getString("kind")%>">滚动图片</a></TD>
  </TR></TBODY></TABLE>
<br>
