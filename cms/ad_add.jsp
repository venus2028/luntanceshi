...
if (op.equals("add")) {
	...
	AdDb ad = new AdDb();
	try {
		if (qom.create(request, ad, "cms_ad_create"))
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
          ...
          <tbody style="display: yes">
            ...
            <tr>
			  ...
			  <input name="ad_type" value="<%=ad_type%>" type="hidden">			  </td>
            </tr>
            <tr>
              <td width="60%">
              ...
              <td ><input type="text" size="30" name="title" value="">              </td>
            </tr>
            <tr>
              ...
              <td><span class="TableData">
                ...
                <textarea name="boardNames" cols="40" rows="5" readOnly wrap="yes" id="boardNames"></textarea>
                <br>&nbsp;
				<input class="SmallButton" title="<%=SkinUtil.LoadString(request, "res.label.forum.admin.ad_list", "add_department")%>" onClick="openWinDir()" type="button" value="<%=SkinUtil.LoadString(request, "res.label.forum.admin.ad_list", "add")%>" name="button">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
              ...
              <td ><input size="30" name="begin_date" value="<%=DateUtil.format(new java.util.Date(), "yyyy-MM-dd")%>" onclick="showcalendar(event, this)">              </td>
            </tr>
            <tr>
              ...
              <td ><input size="30" name="end_date" value="" onclick="showcalendar(event, this)">              </td>
            </tr>
        </table>
		<div id="kind"></div>
        <center>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
            ...
            <tr>
              ...
              <td><textarea rows="5" name="content" id="content" cols="40"></textarea></td>
            </tr>
          </table>
        </div>
