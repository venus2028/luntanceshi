...
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  ...
  <tr> 
    <td valign="top"><br>
      ...
      <TBODY>
      <form name="fmFilter" action="visit_column_statistic_day_detail.jsp?op=search&dirCode=<%=dirCode%>" method="post">
        <TR>
...
<script type="text/javascript">
	...
	String sql = "select count(*) from " + vdld.getTable().getName() + " where column_code=? and add_date>=? and add_date<?";
	int dayCount = 0;
  ...
  <tr>
    <td align="center"><%
JFreeChart chart = ChartFactory.createBarChart3D("栏目日访问统计图", 
                  "日期",
                  "访问量",
                  dataset,
