...
if (op.equals("setImg")) {
	...
	out.print(StrUtil.Alert_Redirect("操作成功！", "ad_img_scroll.jsp"));
}
    ...
    <td valign="top"><br>
      <table width="490" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="81" align="center"><a href="ad_img_scroll.jsp">滚动图片</a></td>
        </tr>
      </table>
      <br>
      <br>
      ...
      <table width="73%" align="center" class="frame_gray">
        <form id=form<%=k%> name=form<%=k%> action="?op=setImg" method=post>
          ...
          <tr>
            ...
            &nbsp;&nbsp;
            <input name="submit23" type="button" onClick="if (confirm('您确定要删除吗？')) window.location.href='ad_img_scroll.jsp?op=del&id=<%=e.getAttribute("id").getValue()%>'" style="border:1pt solid #636563;font-size:9pt; LINE-HEIGHT: normal;HEIGHT: 18px;" value="删 除"></td>
          </tr>
        </form>
      </table>
      <BR>
