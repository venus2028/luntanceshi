...
<%
	...
	String sql = "select name,realname from users order by doc_count desc";            
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>选择日期：
    <input type="text" id="date" name="date" size="10" value="<%=DateUtil.format(date, "yyyy-MM-dd")%>" onChange="window.location.href='doc_statistic_user_list.jsp?date='+this.value">
...
<table style="BORDER-RIGHT: #a6a398 1px solid; BORDER-TOP: #a6a398 1px solid; BORDER-LEFT: #a6a398 1px solid; BORDER-BOTTOM: #a6a398 1px solid" cellSpacing="0" cellPadding="3" width="95%" align="center">
  <tbody>
    <tr>
      <td class="thead" style="PADDING-LEFT: 10px" noWrap width="9%">用户名</td>
      <td width="12%" noWrap class="thead" style="PADDING-LEFT: 10px"><img src="images/tl.gif" align="absMiddle" width="10" height="15">总数</td>
      <td width="16%" noWrap class="thead" style="PADDING-LEFT: 10px"><img src="images/tl.gif" align="absMiddle" width="10" height="15">当年发表数</td>
      <td width="15%" noWrap class="thead" style="PADDING-LEFT: 10px"><img src="images/tl.gif" align="absMiddle" width="10" height="15">当月发表数</td>
      <td width="16%" noWrap class="thead" style="PADDING-LEFT: 10px"><img src="images/tl.gif" align="absMiddle" width="10" height="15">前两天发表数</td>
      <td width="14%" noWrap class="thead" style="PADDING-LEFT: 10px"><img src="images/tl.gif" align="absMiddle" width="10" height="15">前一天发表数</td>
...
%>
    <tr onMouseOver="this.className='tbg1sel'" onMouseOut="this.className='tbg1'" class="tbg1">
      <td style="PADDING-LEFT: 10px">&nbsp;<a href="doc_statistic_user.jsp?userName=<%=StrUtil.UrlEncode(name)%>"><%=realname%></a></td>
      <td style="PADDING-LEFT: 10px"><a href="doc_statistic_user.jsp?userName=<%=StrUtil.UrlEncode(name)%>"><%=user.getDocCount()%></a></td>
...
<div style="text-align:center">
  <input name="button" type="button" onclick="window.location.href='doc_statistic_user_list.jsp?op=initUser'" value="重新统计个人发表总数" />
  &nbsp;&nbsp;&nbsp;
