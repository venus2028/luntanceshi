...
cellSpacing=0 cellPadding=3 width="85%" align=center>
  <!-- Table Head Start-->
  <TBODY>
    <TR>
      <TD class=thead style="PADDING-LEFT: 10px" noWrap width="72%">
      <lt:Label res="res.label.cms.cache" key="java_vm"/>      </TD>
      <TD class=thead style="PADDING-LEFT: 10px" noWrap width="28%">
        <lt:Label res="res.label.cms.cache" key="scheduler"/>
      </TD>
    </TR>
...
%>
          ...
          <br>
          >>&nbsp;<a href="cache_jvm.jsp"><lt:Label res="res.label.cms.cache" key="mem_mgr"/></a>
        </ul>
      <%	// Destroy the runtime reference
	runtime = null;
%>
      <%if (rmcache.getCanCache()) {%>
	  <lt:Label res="res.label.cms.cache" key="cache_started"/> >>&nbsp;<a href="cache.jsp?op=stopcache"><lt:Label res="res.label.cms.cache" key="cache_stop"/></a>
	  <%}else{%>
	  <lt:Label res="res.label.cms.cache" key="cache_stoped"/> >>&nbsp;<a href="cache.jsp?op=startcache"><lt:Label res="res.label.cms.cache" key="cache_start"/></a>
	  <%}%>
&nbsp;&nbsp;&nbsp;      &nbsp;<a href="cache.jsp?op=clear">
<lt:Label res="res.label.cms.cache" key="cahce_all_clear"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="cache.jsp?op=refreshfulltext"><lt:Label res="res.label.cms.cache" key="cache_refresh"/></a><br>
<br>
      <a href="cache.jsp?op=reloadConfig"><lt:Label res="res.label.cms.cache" key="cache_refresh_config_file"/></a>
	  (
      ...
      <TD align="left" valign="top" style="PADDING-LEFT: 10px; line-height:150%">
	  <lt:Label res="res.label.cms.cache" key="scheduler_status"/>
