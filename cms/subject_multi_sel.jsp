...
function setSubjects() {
   var depts = dialogArguments.getSubjects();
   var ary = depts.split(",");
...
function selSubjects() {
	window.returnValue = getSubjects();
	window.close();
}
...
<table width="460" border="0" align="center" cellpadding="0" cellspacing="0" class="tableframe">
  <tr> 
    <td height="24" colspan="2" align="center" background="images/top-right.gif" class="right-title">专题选择</td>
  </tr>
  ...
  <tr> 
    ...
    <td width="249">
<%
SubjectMgr dm = new SubjectMgr();
SubjectDb dd = dm.getSubjectDb(SubjectDb.ROOTCODE);
SubjectView tv = new SubjectView(dd);
tv.ListFuncWithCheckbox(out, "", "func", "", "");
%></td>
  </tr>
  </form>
  <tr align="center">
...
&nbsp;&nbsp;&nbsp; 
      ...
      &nbsp;&nbsp; 
      <input type="button" name="okbtn" value="确定" onClick="selSubjects()">
&nbsp;&nbsp;&nbsp; 
