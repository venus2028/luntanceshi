...
if (user.isForegroundUser()) {
	...
	if (vsite.size()>0) {
		response.sendRedirect("site.jsp?siteCode=" + ((SiteDb)vsite.elementAt(0)).getString("code"));
		return;
	}
}
%>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center>
              <TBODY>
                <TR>
                  <TD align=middle><iframe src="../cache.jsp" width=100% height="300" scrolling="no"></iframe>
                  </TD>
                </TR>
              </TBODY>
            </TABLE>
