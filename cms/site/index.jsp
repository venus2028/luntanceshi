...
<HTML><HEAD><TITLE><%=cn.js.fan.web.Global.AppName%> - <lt:Label res="res.label.cms.index" key="msg"/></TITLE>
...
<%
cn.js.fan.security.Login.initlogin(request,"redmoon");
%>
<CENTER>
                ...
                <TD colSpan=2>
                  <TABLE cellSpacing=0 cellPadding=0 width=526 border=0>
                    ...
                    <TR>
                      ...
                      <TD width=110><input type=image style="CURSOR: hand"                         src="../images/al_end_right.gif" 
...
function admin_login_chk()
{
  ...
  {
    alert("<lt:Label res="res.label.cms.index" key="sorry"/>" + "\n" + "<lt:Label res="res.label.cms.index" key="username"/>");
    document.admin_frm.username.focus();
    return false;
  }
  if (password=="" || password==null)
  {
    alert("<lt:Label res="res.label.cms.index" key="sorry"/>" + "\n" + "<lt:Label res="res.label.cms.index" key="adminpass"/>");
