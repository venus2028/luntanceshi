...
<%@ include file="visit_inc_nav.jsp"%>
<script>
$("menu5").className="active"; 
</script>
<%
	...
	fmFilter.endDate.value = "<%=endDate%>";
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="center">
<%	
	String sql = "select count(*) as s, ip_address from " + bvld.getTable().getName() + " v, document d where v.doc_id=d.id and d.site_code=" + StrUtil.sqlstr(siteCode);
