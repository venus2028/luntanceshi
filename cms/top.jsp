  ...
  <TR>
    ...
    <TD style="PADDING-RIGHT: 20px">
      <TABLE width="100%" align=right class=wht>
        <TBODY>
        <TR>
          <TD align="right"><span class="style1"><span class="style2"><%=user.getRealName()%>，最后登录：<%=DateUtil.format(user.getEnterLast(), "yy-MM-dd HH:mm")%>&nbsp;</span>&nbsp;&nbsp;&nbsp;</span><IMG height=7 hspace=5 
