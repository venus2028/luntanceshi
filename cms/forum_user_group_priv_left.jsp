...
DirectoryView dv = new DirectoryView(request, rootLeaf);
dv.ListSimple(out, "userGroupMainFrame", "forum_user_group_priv.jsp?group_code=" + StrUtil.UrlEncode(groupCode) + "&dir_code=", "", "" ); // "tbg1", "tbg1sel");
%>
