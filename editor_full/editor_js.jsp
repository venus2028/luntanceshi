...
function cws_validateMode()
{
	...
	alert("<editor_js_lt:Label res="res.label.editor_full.editor" key="info_mode_submit"/>");
	IframeID.focus();
	return false;
}
...
function cws_FilterScript(content)
{
	...
	content = content.replace(RegExp, "<editor_js_lt:Label res="res.label.editor_full.editor" key="info_script"/>");
	RegExp = /<P>&nbsp;<\/P>/gi;
