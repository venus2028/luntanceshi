...
<%
String isWebedit = cn.js.fan.util.ParamUtil.get(request, "isWebedit");
%>

function IsWebedit() {
<%
	if (cn.js.fan.util.ParamUtil.get(request, "isWebedit").equals("true"))
		out.println("true");
	else
		out.println("false");
%>
...
{
if (cws_bIsIE5){	
	var arr=showModalDialog(editorRootPath + "/editor_full/images/img.jsp?isWebedit=<%=isWebedit%>", window, "dialogWidth:26em; dialogHeight:20.5em; status:0; help:0");
	IframeID.focus();
	if (arr != null)
	{
		//content=cws_Composition.document.body.innerHTML;
