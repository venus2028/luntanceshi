...
<TABLE cellSpacing=0 cellPadding=0 align=center border=0>
  ...
  <TR>
    <TD align=right height="90">
      	<FIELDSET><LEGEND><lt:Label res="res.label.editor_full.img" key="img_localhost"/></LEGEND>
		<%
		...
		%>
		<iframe src="<%=request.getContextPath()%>/forum/uploadimg.jsp" width=100% height="48" frameborder="0" scrolling="no"></iframe>
		<%}%>
		</FIELDSET>
		</TD>
  </TR>  
      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
        <TBODY>
          ...
          <TR>
            ...
            <TD width=7></TD></TR>
          <TR>
          <TD colSpan=9 height=5></TD></TR></TBODY>
      </TABLE></FIELDSET></TD></TR>
  
  <TR>
    <TD height=5></TD></TR>
  <TR>
    <TD align=center><INPUT id=d_upfilename type=hidden> <INPUT id=Ok onclick=ok() type=submit value="<lt:Label res="res.label.editor_full.img" key="ok"/>"> &nbsp;&nbsp; <INPUT onclick=window.close(); type=button value="<lt:Label res="res.label.editor_full.img" key="cancel"/>"></TD>
  </TR>
  </TBODY></TABLE>
</BODY></HTML>
