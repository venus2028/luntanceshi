  ...
  <tbody>
    <tr>
	  ...
	  if (!op.equals("search")) {
		...
		%>
      &nbsp;&nbsp;<a href="music_list_pic.jsp?dirCode=<%=StrUtil.UrlEncode(dirCode)%>&action=<%=action%>">缩略图</a></td>
    </tr>
  </tbody>
</table>
<br>
...
String isRelatePath = cfg.getProperty("cms.isRelatePath"); 	
	%>
      <object classid="CLSID:DE757F80-F499-48D5-BF39-90BC8BA54D8C" codebase="<%=request.getContextPath()%>/activex/webedit.cab#version=6,0,2,1" width=400 height=175 align="middle" id="webedit">
