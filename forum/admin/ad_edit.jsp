        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableborder">
          ...
          <tbody style="display: yes">
            ...
            <tr>
              ...
              <td>
			  <input size="30" name="begin_date" value="<%=DateUtil.format(ad.getDate("begin_date"), "yyyy-MM-dd")%>">
    ...
    Calendar.setup({
        ...
        step           :    1                // show all years in drop-down boxes (instead of every other year as default)
            ...
            <tr>
              ...
              <td>
			  <input size="30" name="end_date" value="<%=DateUtil.format(ad.getDate("end_date"), "yyyy-MM-dd")%>">
<script type="text/javascript">
    Calendar.setup({
