...
%>
<jsp:useBean id="dm" scope="page" class="com.redmoon.forum.music.MusicDirMgr"/>
<%
...
MusicDirDb leaf = dm.getMusicDirDb(root_code);
if (op.equals("repair")) {
	dm.repairTree(leaf);
	leaf = dm.getMusicDirDb(root_code);
}
...
MusicDirView dv = new MusicDirView(leaf);
dv.ListSimple(out, "mainFileFrame", "music_list.jsp?action=" + action + "&dirCode=", "", "" );
%></TD>
    </TR>
  </TBODY>
</TABLE>
