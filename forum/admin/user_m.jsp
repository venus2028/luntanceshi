...
border=0 align=center cellPadding=2 cellSpacing=1 bgcolor="#edeced">
    <TBODY>
      <TR align=center bgColor=#f8f8f8> 
        <TD width=3% height=23 bgcolor="#E2E0DC"><font color="#525252">&nbsp;</font></TD>
        <TD width=15% bgcolor="#E2E0DC"><font color="#525252">
        <lt:Label res="res.label.forum.admin.user_m" key="user_name"/></font></TD>
        <TD width=4% height=23 bgcolor="#E2E0DC"><font color="#525252">
        <lt:Label res="res.label.forum.admin.user_m" key="gender"/></font></TD>
        <TD width=16% height=23 bgcolor="#E2E0DC" onClick="doSort('lastTime')" style="cursor:hand"><font color="#525252">
        ...
        <TD width=6% bgcolor="#E2E0DC"><font color="#525252">
        <lt:Label res="res.label.forum.admin.user_m" key="credit"/></font></TD>
        <TD width=11% height=23 bgcolor="#E2E0DC" onClick="doSort('RegDate')" style="cursor:hand"><font color="#525252">
        ...
        <TD width=11% bgcolor="#E2E0DC" onClick="doSort('group_code')" style="cursor:hand"><lt:Label res="res.label.forum.admin.user_m" key="user_group"/>
        ...
        <TD width=6% bgcolor="#E2E0DC"><lt:Label key="op"/></TD>
      </TR>
      <%		
...
%>
      <TR align=center onMouseOver="this.className='tbg1sel'" onMouseOut="this.className='tbg1'" class="tbg1"> 
        ...
        <TD width=4% height=23><%=Gender%></TD>
		...
		%>		</TD>
        <TD width=6%><%=credit%></TD>
        <TD width=11% height=23><%=RegDate%></TD>
        <TD width=11%>
		<%
        ...
        <TD width=6% height=23>&nbsp;          <a href="user_modify.jsp?username=<%=StrUtil.UrlEncode(name)%>&privurl=<%=privurl%>">
        <lt:Label res="res.label.forum.admin.user_m" key="manage"/></a></TD>
      </TR>
<%}%>
    </TBODY>
  </TABLE>
