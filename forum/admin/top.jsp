    ...
    <TD style="PADDING-RIGHT: 20px">
      <TABLE width="459" align=right class=wht>
        ...
        <TR>
		  ...
		  <%=user.getRealName()%>，最后登录：<%=DateUtil.format(user.getEnterLast(), "yy-MM-dd HH:mm")%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><IMG height=7 hspace=5 
            src="images/arrow_white.gif" width=6 
            algin="absmiddle"><A href="javascript:location.reload();" 
            target=mainFrame>
		  <lt:Label res="res.label.forum.admin.top" key="refresh"/></A> <IMG height=7 hspace=5 
            src="images/arrow_white.gif" width=6 
            algin="absmiddle"><A 
            href="main.jsp" 
            ...
            target=_top>
		  <lt:Label res="res.label.forum.admin.top" key="exit"/></A> </TD>
        </TR>
        <TR>
