            ...
            <td valign="top"><table width="100%" border='0' cellspacing='0' cellpadding='0'>
                ...
                <tr>
                  <FORM METHOD=POST ACTION="?op=setFilterName" name="form2">
                    <td height="23" colspan=3 align="center" class="stable"><table width="100%">
                        <tr>
                      ...
                      <FORM METHOD=POST ACTION="?op=setFilterMsg" name="form3">
                        <tr>
                          <td width="18%" height="22" align="center"><lt:Label res="res.label.forum.admin.forum_m" key="filter_keywords"/></td>
                        </tr>
                        <tr>
                          <td height="22" align="center"><textarea name="filterMsg" cols="50" rows="3" id="filterMsg" style='border:1pt solid #636563;font-size:9pt'><%=fd.getFilterMsg()%></textarea></td>
                        </tr>
                        <tr>
