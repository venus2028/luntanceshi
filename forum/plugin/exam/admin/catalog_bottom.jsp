            ...
            <form name="form1" method="post" action="catalog_top.jsp?op=<%=op%>" target="dirmainFrame" onClick="return form1_onsubmit()">
              ...
              <tr>
                <td align="left">名称
                    ...
                    <input name="seltype" value="0" type="hidden">
...
%>
                <input name="isHome" type=checkbox value="true" <%=isHome?"checked":""%>>启用
				<input name="templateId" type="hidden" value="-1">
                </span></td>
              </tr>
              <tr>
                <td align="left"><input name="Submit" type="submit" class="singleboarder" value="提交">
                  &nbsp;&nbsp;&nbsp;
