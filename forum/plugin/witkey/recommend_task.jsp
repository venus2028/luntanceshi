...
<%
	...
	String sql = "select msg_root_id from plugin_witkey where level>0 and end_date>" + StrUtil.sqlstr(Long.toString(System.currentTimeMillis() - 24*60*60*1000)) + " order by level desc";
...
%>
<div class="tableTitle">威客推荐任务列表</div> 
