...
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<%=WitkeySkin.LoadString(request, "name")%></td>
  </tr>
</table>
<br>
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  <tr> 
    <td height=20 align="left" class="thead">管理 - <%=WitkeySkin.LoadString(request, "name")%></td>
  </tr>
  <tr> 
    <td valign="top"><table width="82%"  border="0" align="center">
      <tr>
        <td height="34" align="center"><img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;<a href="catalog_frame.jsp">威客分类</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;<a href="witkey_task_list.jsp">设置任务等级</a></td>
      </tr>
    </table>
      <br>
...
<%}%>	  
	  ...
	  <form action="?op=addBoard" method=post>
        <tr>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="44%" align="left"><input type=submit value="设为支持<%=WitkeySkin.LoadString(request, "name")%>功能"></td>
        </tr></form>
      </table>
      <br></td>
  </tr>
