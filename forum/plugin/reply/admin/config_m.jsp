...
com.redmoon.forum.plugin.reply.ReplyConfig myconfig = com.redmoon.forum.plugin.reply.ReplyConfig.getInstance();
...
if (name!=null && !name.equals("")) {
	...
	myconfig.setProperty("reply." + name,value);
	out.println(fchar.Alert_Redirect(SkinUtil.LoadString(request, "info_op_success"), "config_m.jsp"));
	myconfig.reload();
	myconfig = com.redmoon.forum.plugin.reply.ReplyConfig.getInstance();	
	return;
}

int k = 0;
Iterator ir = root.getChild("reply").getChildren().iterator();
String desc = "";
while (ir.hasNext()) {
