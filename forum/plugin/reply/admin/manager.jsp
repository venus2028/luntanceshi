...
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<%=ReplySkin.LoadString(request, "name")%></td>
  </tr>
</table>
<br>
<table width="98%" border='0' align="center" cellpadding='0' cellspacing='0' class="frame_gray">
  <tr> 
    <td height=20 align="left" class="thead">管理 - <%=ReplySkin.LoadString(request, "name")%></td>
  </tr>
  <tr> 
    <td valign="top"><table width="82%"  border="0" align="center">
      <tr>
        <td height="34" align="center">&nbsp;<img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;&nbsp;<a href="config_m.jsp">政务问答配置</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../../../../images/arrow.gif" width="5" height="7">&nbsp;<a href="topic_check.jsp">审核贴子</a></td>
      </tr>
    </table>
      <br>
...
%>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td width="44%" align="left"><input type=submit value="设为支持<%=ReplySkin.LoadString(request, "name")%>功能"></td>
        </tr></form>
    </table>      <br></td>
  </tr>
</table>
