...
<br>
<FORM action="reply_add.jsp?op=add" method="post" name="form1" onSubmit="return form1_onsubmit()">
	...
	<thead>
      ...
      <TBODY>
        <TR bgColor=#f5f5f5 align="center">
          <TD height=22 align="center"><lt:Label res="res.label.forum.manager" key="topic"/></TD>
        ...
        <TR bgColor=#f5f5f5 align="center">
          <TD width="15%" height=22 align="center">回复</TD>
          <TD width="85%" height=22 align="left">
		  <%
			String rpath = request.getContextPath();
			ReplyDb rd = new ReplyDb();
			rd = (ReplyDb)rd.getQObjectDb(new Long(msgId));
			String content = "";
			if (rd!=null) {
