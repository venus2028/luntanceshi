            ...
            <td width="45%" rowspan="6" align="center"><%
				...
				if (!logo.equals("")) {
					...
					if (isFtpUsed) {
			     	...
			     	%>
              <img src="<%=attachmentBasePath + logo%>" <%=w%>>
              <%}
				%>
			</td>
          ...
          <TBODY>
            ...
            <TR vAlign=top>
              <TD height="251" colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <%
AlipayDb ali = new AlipayDb();				
String sql = "select msgRootId from " + ali.getTableName() + " a, sq_thread t where t.id=a.msgRootId and t.name="+StrUtil.sqlstr(userName) + " order by t.lydate desc";

String op = ParamUtil.get(request, "op");
String what = ParamUtil.get(request, "what");
if (op.equals("search")) {
	sql = "select msgRootId from " + ali.getTableName() + " a, sq_thread t where t.id=a.msgRootId and t.name="+StrUtil.sqlstr(userName) + " and a.alipay_subject like " + StrUtil.sqlstr("%" + what + "%") + " order by t.lydate desc";
}
...
ListResult lr = ali.listResult(sql, curpage, pagesize);
                ...
                <table width="91%" border="0" cellspacing="0" cellpadding="0" align="center" class="p9" height="24">
                  <tr>
                    <td width="100%" height="24" valign="bottom"><div align="right">共 <b><%=paginator.getTotal() %></b> 条　每页<b><%=paginator.getPageSize() %></b> 条　<b><%=curpage %>/<%=totalpages %></b> &nbsp;&nbsp;
                        <%
	  String querystr = "userName=" + StrUtil.UrlEncode(userName) + "&op=" + op + "&what=" + StrUtil.UrlEncode(what);
...
%>
                      <table width="120" border=0 align="left" class="p9">
                        <tr>
                          <td width="154" height="24" align="center" valign="top">&nbsp; <a href="../../showtopic.jsp?rootid=<%=ali.getMsgRootId()%>" class="link_commodity"><%=StrUtil.toHtml(ali.getSubject())%></a></td>
                        </tr>
                        <tr>
                          <td height="40" align="center">邮递：<%=ali.getTransportDesc(request)%></td>
                        </tr>
                        <tr>
...
<table width="98%"  border="0" align="center">
  <tr>
    <td height="34" align="center"><HR style="height:1px; color:"#999999">
      Copyright 2005 版权所有：<a href="http://<%=Global.server%>" class="link_commodity"><%=Global.AppName%></a></td>
  </tr>
</table>
</BODY>
</HTML>
