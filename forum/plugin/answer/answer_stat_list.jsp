...
function doSort(orderBy) {
	...
	window.location.href = "answer_stat_list.jsp?op=<%=op%>&showYear=<%=showYear%>&showMonth=<%=showMonth%>&orderBy=" + orderBy + "&sort=" + sort;
}
</script>
</head>
<body>
...
%>
  <div align="center"><br>
	...
	<form name="formSearch" action="answer_stat_list.jsp" method="get">	
      <tr>
  ...
  <%				
  	AnswerStatDb asd = new AnswerStatDb();
  ...
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <%
	  String querystr = "op=" + op + "&showYear=" + showYear + "&showMonth=" + showMonth + "&orderBy=" + orderBy + "&sort=" + sort;
 	  out.print(paginator.getCurPageBlock("answer_stat_list.jsp?"+querystr));
	%></td>
    </tr>
  </table>
</div>
