...
<table width='100%' cellpadding='0' cellspacing='0' >
  <tr>
    <td class="head">管理插件-<a href=manager.jsp><%=AnswerSkin.LoadString(request, "name")%></a>的规则</td>
  </tr>
</table>
<br>
  ...
  <tr> 
    <td valign="top"><br>
      ...
      <tr align="center">
        ...
        <td height="22" align="left"><textarea name="boardRule" cols="78" rows="10"><%=sb.getBoardRule()%></textarea></td>
        </tr>
      <tr align="center">
