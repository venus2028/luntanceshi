...
<td width="99%" align="center" valign="top">
    <div align="left"><b>欢迎您使用云网社区 <font style="font-size='14px';color='red'">ORACLE版本</font><%=cfg.get("Application.version")%></b></div>
    <hr size="0">
<%
...
try
{
	...
	//jdbc:oracle:thin:@//192.168.1.27:1521/cwbbs
...
{
	out.print("<font style='font-size:14px' color='#FF0000'>请检查WEB-INF/proxool.xml文件中的driver-class是否设置正确！<br>参照设置为：oracle.jdbc.driver.OracleDriver</font><br>");
}
catch(Exception e)
{
	out.print("<font style='font-size:14px' color='#FF0000'>请检查WEB-INF/proxool.xml文件中的driver-url是否设置正确！<br>参照设置为：jdbc:oracle:thin:@//192.168.1.27:1521/cwbbs</font><br>");
}	
...
if (op.equals("setup")) {
	...
	cfg.set("proxool.driver-class", "oracle.jdbc.driver.OracleDriver");
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="button2" type="button" onclick="window.location.href='setup3.jsp?db_type=oracle'" value="下一步" /></td>
</tr>
</table>
