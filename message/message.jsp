  ...
  <tr> 
    <td bgcolor="#FFFFFF" height="50"> 
        <table width="300" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr> 
            <td width="75"> 
              <div align="center"><img src="images/m_inbox.gif" width="40" border="0" alt="<lt:Label res="res.label.message.message" key="recever_mail"/>"> <br>
                <lt:Label res="res.label.message.message" key="recever_mail"/>			  
			  </div>
            </td>
            <td width="75"> 
              <div align="center"><a href="mysend.jsp"><img src="images/m_outbox.gif" alt="<lt:Label res="res.label.message.message" key="send_mail"/>" width="40" border="0"> <br>
                <lt:Label res="res.label.message.message" key="send_mail"/>			  
			  </a></div>
            </td>
            <td width="75"> 
              <div align="center"><a href="send.jsp"><img src="images/newpm.gif" width="40" border="0" alt="<lt:Label res="res.label.message.message" key="write_mail"/>"> <br>
              	<lt:Label res="res.label.message.message" key="write_mail"/>
			  </a></div>
            </td>
            <td width="75"> 
              <div align="center"> 
                <img border="0" name="imageField" alt="<lt:Label res="res.label.message.message" key="del_mail"/>" src="images/m_delete.gif" width="40" onClick="form1.submit()" style="cursor:hand"> <br>
                <lt:Label res="res.label.message.message" key="del_mail"/>				
				</div>
            </td>
          </tr>
        </table>
...
while (ir.hasNext()) {
		...
		if (!sender.equals(md.USER_SYSTEM)) {
			com.redmoon.forum.person.UserDb user = um.getUser(sender);
			if (user.isLoaded()) {
				sender = user.getNick();
			}
		}
                  ...
                  <table width="310" border="0" cellspacing="1" cellpadding="3" align="center" class="p9">
                    <tr>
                      ...
                      <td width="210">&nbsp;<a href="showmsg.jsp?id=<%=id%>" class="9black2">
                        <%if (isreaded) {%>
                        <%=StrUtil.getLeft(StrUtil.toHtml(title), 22)%>
                        <%}else{%>
                        <b><%=StrUtil.getLeft(StrUtil.toHtml(title), 20)%></b>
                        <%}%>
...
<% if(paginator.getTotal()>0){ %>
        <table width="310" border="0" cellspacing="0" cellpadding="0" align="center" class="p9" height="24">
          <tr>
            <td height="24" valign="bottom"> <div align="right"><a href="javascript:selAllCheckBox('ids')"><lt:Label res="res.label.message.message" key="sel_all"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
              <lt:Label res="res.label.forum.listtopic" key="find_record"/><b><%=paginator.getTotal() %></b> 
