...
<table align="center" class="tableCommon80">
  <thead>
  <tr align="center">
    <td height="25"><%=Global.AppName%> - <lt:Label res="res.label.info" key="info"/></td>
  </tr>
  </thead>
  <tr valign="middle"> 
    <td>
	<div class="infoBox"><ul><li><%=info%></li>
      ...
      <table width="90%" align="center" cellpadding="0" cellspacing="0" class="tableBorder1">
          ...
          <tr align="center">
            <td height="35" colspan="2"><input name="submit" type=submit value="<lt:Label res="res.label.door" key="login"/>">              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="infoBox"><ul>
		<li><a href="javascript:history.back(-1)"><lt:Label res="res.label.info" key="back"/></a></li>
